...
## 🏗️ 환경 구성
Controller, Compute, Network, Storage 총 4개의 노드로 구성하였고, 각 노드에 필요한 서비스를 수동 설치했습니다. (각 노드별 하드웨어 스펙 기입) 

또한, 단순히 매뉴얼을 그대로 재현하는 데 그치지 않고, Public Network만을 사용하는 구조에서 확장하여 Self-Service Network를 구축했습니다.
